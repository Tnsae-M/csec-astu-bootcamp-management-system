    ...
    <div className="space-y-10 selection:bg-brand-accent selection:text-white">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          ...
          <p className="text-text-muted text-[11px] font-bold uppercase tracking-widest leading-none">
            Curriculum Governance & Academic Evaluation
          </p>
        </div>
        {/* <div className="flex space-x-3">
          <Button
            size="md"
            className="text-[10px] font-black uppercase tracking-widest px-8 shadow-lg shadow-brand-accent/20"
          >
            Provision Session
          </Button>
          <Button
            variant="secondary"
            size="md"
            className="text-[10px] font-black uppercase tracking-widest px-8 bg-brand-primary border border-brand-border text-brand-accent"
          >
            Upload Resources
          </Button>
        </div> */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 geo-card p-8">
          <h3 className="text-xl font-black text-text-main uppercase tracking-tighter mb-8">
          ...
          <table className="w-full text-left">
            ...
            <tbody>
              {filteredSessions.map((session) => (
                <tr
                  key={session.id}
                  className="border-b border-brand-border grow last:border-0 hover:bg-brand-primary/50 transition-colors"
                >
                  <td className="py-5">
                    <p className="font-bold text-sm text-text-main uppercase tracking-tight">
                      {session.title}
                    </p>
                  ...
                  <td className="py-5 text-xs font-bold text-text-muted uppercase tracking-widest">
                    {session.division}
                  </td>
                  <td className="py-5">
                    <span
